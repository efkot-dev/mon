...
if(!empty($getOLT['netip']) && !empty($getOLT['class']) && $getOLT['oidid']==9){
	...
	if($onu_rx_value) {
		...
		echo'<div class="dbm_block"><div class="i"><img src="../style/img/rx.png"></div><div class="text"><div class="n">RX ONU</div><div class="s"><span style="color:' . $olt_color . ';">' . $onu_rx_value . '</span><b>dBm</b></div></div></div>';
	}		
	...
	if($onu_volt_value) {
		...
		echo'<div class="dbm_block"><div class="i"><img src="../style/img/voltage.png"></div><div class="text"><div class="n">Volt</div><div class="s"><span style="color:' . $olt_color . ';">' . $onu_volt_value . '</span><b>V</b></div></div></div>';
	}	
	echo'</div>';	
}
}
