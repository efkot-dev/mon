...
if(!empty($getOLT['netip']) && !empty($getOLT['class']) && $getOLT['oidid']==41){	
	...
	echo'<div class="block_dbm">';
	$tx_value = @snmp2_get($getOLT['netip'], $getOLT['snmpro'],'1.3.6.1.4.1.17409.2.8.4.4.1.5.'. $getONT['keyonu'].'.0.0');
	if ($tx_value) {
	...
	$rx_value = @snmp2_get($getOLT['netip'], $getOLT['snmpro'], '1.3.6.1.4.1.17409.2.8.4.4.1.4.'. $getONT['keyonu'].'.0.0');
	if ($rx_value) {
