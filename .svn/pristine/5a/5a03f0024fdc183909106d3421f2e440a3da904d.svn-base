...
ul li{margin: 0;padding: 0;list-style: none; padding-left: 0;border-bottom: 1px solid #9ccfe6;font-size: 13px;}
...
.superw{margin-right: 10px;display: inline-block;padding: 1px 15px 3px 15px;background: #0297dc;border-radius: 3px;color: #fff;font-size: 14px;text-decoration: none;}
.superw:hover{margin-right: 10px;display: inline-block;padding: 1px 15px 3px 15px;background: red;border-radius: 3px;color: #fff;font-size: 14px;text-decoration: none;}
